...
export default function JobCard({ 
    ...
    const renderBadge = () => {
        ...
        return (
            <span className={`text-[14px] font-semibold px-2 py-0.5 rounded text-white flex-shrink-0 ${dDayColor}`}>
                {dDayText}
            </span>
        );
    };
        ...
        >
            ...
            <a href={url} target="_blank" rel="noopener noreferrer" className="block">
                <div className="flex items-center gap-3 mb-3">
                    {/* 로고 영역 */}
                    <div className="w-16 h-16 bg-white rounded-lg overflow-hidden flex items-center justify-center p-1.5 flex-shrink-0">
                        {logo ? (
                ...
                {/* 하단 정보 */}
                <div className="flex items-center gap-3 text-[14px] text-gray-500 pt-2 border-t border-white/5">
